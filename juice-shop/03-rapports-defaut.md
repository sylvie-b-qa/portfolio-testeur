...
## JS-BUG-01 — Incohérence entre la règle affichée (5 caractères minimum) et les conseils (8 caractères minimum) pour le mot de passe
...
## JS-BUG-02 — Le compteur de caractères affiche 0/20 au lieu de 0/40 pour le champ mot de passe
