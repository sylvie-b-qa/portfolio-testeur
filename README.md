...
recherche et le parcours de prise de rendez-vous de Doctolib.

- 17 cas de test (partitions d'équivalence, analyse des valeurs limites, 
  tables de décision, transitions d'état)
- 2 rapports de défaut
- 3 anomalies documentées à clarifier
...
- Analyse des valeurs limites (AVL)
- Tables de décision
- Transitions d'état
- Test exploratoire
